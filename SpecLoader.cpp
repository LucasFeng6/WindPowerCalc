...
static const char* kEmbeddedSpec = R"JSON(
{
  ...
  "items": [
    ...
    { "id":"loss_dc_cable", "group":"损耗费用", "label":"直流海缆损耗", "unit":"万元/年", "inputs":[
      ...
      "formula":"result = resistance*current*current*length*circuits*loss_hours*price/1000.0/10000.0;" },
    ...
    { "id":"loss_converter", "group":"损耗费用", "label":"变电/换流损耗", "unit":"万元/年", "inputs":[
        {"name":"transformer_capacity","label":"变压器输送容量","type":"double","unit":"kW","required":false,"defval":0},
        {"name":"valve_capacity","label":"换流阀输送容量","type":"double","unit":"kW","required":false,"defval":0},
        {"name":"loss_hours","label":"损耗小时数","type":"double","unit":"h","required":false,"defval":0},
        {"name":"price","label":"电价","type":"double","unit":"元/kWh","required":false,"defval":0}
      ],
      "formula":"result = (transformer_capacity + valve_capacity) * loss_hours * price / 10000.0;" },
    ...
    { "id":"loss_reactor", "group":"损耗费用", "label":"高抗损耗", "unit":"万元/年", "inputs":[
      ...
      "formula":"result = charge_power * loss_hours * price / 10000.0;" },
